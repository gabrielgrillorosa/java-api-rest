...
class PessoaServiceTes {
    ...
    void cria_RetornaPessoaCriada_CasoSucesso(){
       ...
       Assertions.assertTrue(pessoa.getNome() == pessoaMock.getNome());             
    ...
    void atualiza_RetornaPessoaCriada_CasoSucesso(){
       ...
       Assertions.assertNotNull(pessoa);
       Assertions.assertTrue(pessoa instanceof Pessoa);
       Assertions.assertTrue(pessoa.getCodigo() == pessoaMock.getCodigo());             
    ...
    void atualizaAtivo_CasoSucesso(){
       ...
       Assertions.assertTrue(pessoaAtualizada.getCodigo() == pessoa.getCodigo());
       Assertions.assertFalse(pessoaAtualizada.getAtivo() == pessoa.getAtivo());
